...
const menuData = {
    pita: [
        {
            name: "Falafel", img: "./assets/images/PitaImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
    ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
        },
        {
            name: "Falafel", img: "./assets/images/PitaImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
...
ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
    ...
    salad: [
        {
            name: "Kale cesar", img: "./assets/images/SaladImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
    ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
        },
        {
            name: "Kale cesar", img: "./assets/images/SaladImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
...
ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
    ...
    lunch: [
        {
            name: "Salade dej", img: "./assets/images/LaunchImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
    ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
        },
        {
            name: "Salade dej", img: "./assets/images/LaunchImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
...
ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
    ...
    snack: [
        {
            name: "Boule denergie", img: "./assets/images/SnackImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
    ciboulette, houmous, fromage végétal, sauce à lail.`, price: "10.00$"
        },
        {
            name: "Boule denergie", img: "./assets/images/SnackImage.webp", description: `Kale, falafel, poivron, tomate, betterave, carotte
...
function categoryButtonEvent(e) {
    ...
    dishesContainer.addEventListener('mousemove', (e) => mouseMoveEvent(e, dishesContainer));
    dishesContainer.addEventListener('mousedown', (e) => startDragging(e, dishesContainer));
...
leftArrow.addEventListener('click', () => {
    const activeContainer = document.querySelector('.Main-Dishes-Container > div');
